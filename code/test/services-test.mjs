...
describe('CMDB services', function () {
  ...
  it('create user, create group and get group info', async function() {
      ...
      let newGroup = await fmdbGroupServices.createGroup(userId, "Group 1", "Description 1")
  ...
  it('Create Group and delete it', async function() {
    ...
    let newGroup = await fmdbGroupServices.createGroup(userToken, "Group 2", "Description 2")
  ...
  it('Create Group and update group', async function() {
    // Arrange
    let userToken = await createUserTest()
    let newGroup = await fmdbGroupServices.createGroup(userToken, "Group 3", "Description 3")
    const idGroup = newGroup.groupId
    // Act 
    await fmdbGroupServices.updateGroup(userToken, idGroup, "Group Updated", "Description Updated")
  ...
  it('Add movie to a group and delete it', async function() {
    ...
    let newGroup = await fmdbGroupServices.createGroup(user, "Group 4", "Description 4")
    const idGroup = newGroup.groupId
    // Act 
  ...
  it('Create 3 groups and get All groups', async function() {
    // Arrange
    let userToken = await createUserTest()
    await fmdbGroupServices.createGroup(userToken, "Group 5", "Description 5")
    await fmdbGroupServices.createGroup(userToken, "Group 6", "Description 6")
    await fmdbGroupServices.createGroup(userToken, "Group 7", "Description 7")
    // Act 
